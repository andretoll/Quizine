...
namespace Quizine.Api.Models
{
    public class QuizResult
    {
        ...
        public bool IsAnswerCorrect => IsAnswerValid && Answer.ID == Question.CorrectAnswer.ID;
        public bool IsAnswerValid => Answer != null && !string.IsNullOrEmpty(Answer.ID) && !string.IsNullOrEmpty(Answer.Value);
